#
#  Be sure to run `pod spec lint SRProximityRecord.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://stephenradford.me/replicating-bemes-record-with-the-proximity-sensor/"
  ...
  s.source       = { :git => "https://github.com/steve228uk/SRProximityRecord.git", :tag => "0.0.3" }
